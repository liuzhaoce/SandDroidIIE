...
PERMISSION_DESC={ 
                "ACCESS_CHECKIN_PROPERTIES": "Allows read/write access to the \"properties\" table in the checkin database",
                ...
                "SUBSCRIBED_FEEDS_WRITE": "No Description",
